...
import com.syaiful.moviecatalogue.adapter.SectionsPagerAdapterMovie;
...
public class HomeContainerFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SectionsPagerAdapterMovie sectionsPagerAdapter = new SectionsPagerAdapterMovie(this, getChildFragmentManager());
